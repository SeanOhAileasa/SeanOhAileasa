...
"update repository OSDA ./soc-200 - [V] 19 SIEM Part Two: Combining the Logs - Phase Two: Lateral Movement to Application Server - Brute Force and Authentication to appsrv01 - Phase Two Detection Rules"
