...
<!--
23/07/2021
"update repository ./fda-monty-hall-problem - Analysing the data generated by the class of 2020 capturing the decisions made and the random elements of playing the Win a Car game. Questioning if the students in the class switch door or not. Creating a plot using seaborn.catplot of a single categorical variable (stay) capturing the True and False counts. The bar chart created showed that most students stayed with their initial pick." 
-->
